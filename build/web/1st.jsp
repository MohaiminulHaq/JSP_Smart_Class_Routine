<%-- 
    Document   : 1st
    Created on : Apr 5, 2019, 7:46:47 PM
    Author     : Tanvir
--%>
    ...
    <body>
        ...
        <%
                ...
                try{
                   ...
                   int i=st.executeUpdate("insert into classrotine(one,two,three,four,five,six,seven) values ('"+one+"','"+two+"','"+three+"','"+four+"','"+five+"','"+six+"','"+seven+"')");
